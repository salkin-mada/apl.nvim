...
local default = {
  ...
  --- table
  ---@table default.lang
  ---@field cmd Path to the lang executable. Not needed if lang is already in your $PATH.
  ---@field args Comma separated arguments passed to the lang executable.
  lang = {
    cmd = nil,
    args = {},
  },
  ...
  ---    },
  ---    ['<leader>st'] = map('lang.start'),
  ---    ['<leader>sk'] = map('lang.recompile'),
  ---  }
  keymaps = {},
  ...
  documentation = {
    ...
    keymaps = true,
    -- browser = $BROWSER or ''
    -- wikiurl = "https://aplwiki.com/"
    --https://www.mail-archive.com/bug-apl@gnu.org/
  },
  ...
  postwin = {
    ...
    float = {
      ...
      callback = function(id)
        vim.api.nvim_win_set_option(id, 'winblend', 15)
      end,
    },
  },
  ...
  ---@field force_ft_apl (default: true) Treat .sc files as apl.
