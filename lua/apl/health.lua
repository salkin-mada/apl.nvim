...
local function check_nvim_version()
  ...
  if not supported then
    health.report_error 'apl.nvim needs nvim version 0.7 or higher.'
...
--     health.report_error 'apl classes are not installed.'
--     health.report_info 'use `ensure_installed = true` in the apl setup function'
--   else
--     health.report_ok('apl classes are installed: ' .. class_path)
--   end
-- end
...
--   if ok then
--     health.report_ok('lang executable: ' .. ret)
--   else
...
function M.check()
  health.report_start 'apl'
  check_nvim_version()
  -- check_lang()
  -- check_classes_installed()
  check_keymaps()
  -- health.report_start 'apl documentation'
  -- check_documentation()
  health.report_start 'apl extensions'
  check_extensions()
end
